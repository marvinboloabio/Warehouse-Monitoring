...
<div class="content">
    ...
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-add btn-sm" data-toggle="modal" data-target="#addTruckingModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addTruckingForm">
                    ...
                    <button type="submit" class="btn btn-primary btn-block">Save Truck</button>
...
<!-- EDIT TRUCKING MODAL -->
<div class="modal fade" id="editTruckingModal">
    <div class="modal-dialog">
        <div class="modal-content">

            <div class="modal-header bg-warning text-white">
                <h5 class="modal-title"><i class="fas fa-edit"></i> Edit Truck</h5>
                <button class="close text-white" data-dismiss="modal">&times;</button>
            </div>

            <div class="modal-body">
                <form id="editTruckingForm">
                    ...
                    <button type="submit" class="btn btn-warning btn-block">Update Truck</button>
